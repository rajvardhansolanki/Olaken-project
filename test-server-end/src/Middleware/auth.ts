...
export const auth: express.RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const sellerAuth: express.RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const adminAuth: express.RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const activeSeller: express.RequestHandler = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
